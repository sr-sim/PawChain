        ...
        <>
          ...
          <section className="rounded-3xl border border-orange-100 bg-white p-5 shadow-[0_18px_48px_rgba(155,86,20,0.08)] sm:p-6">
            <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="py-1">
                <div className="flex flex-wrap gap-2"><StatusBadge status={campaign.campaign_status} /><span className="rounded-full border border-orange-100 bg-orange-50 px-3 py-1 text-xs font-black capitalize text-[var(--color-orange)]">{campaign.urgency_level}</span></div>
